...
const contractABI = require("../artifacts/contracts/Weightgridplus.sol/Weightgridplus.json").abi;

program
    .name("weightgridplus-cli")
    .description("CLI tool for Weightgridplus smart contract")
    .version("1.0.0");
